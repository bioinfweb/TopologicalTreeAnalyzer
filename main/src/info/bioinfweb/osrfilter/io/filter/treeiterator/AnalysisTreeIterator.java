 ...
 */
public class AnalysisTreeIterator extends AbstractTreeIterator<OSRFilterTree> {
	...
	@Override
	protected OSRFilterTree loadTree(JPhyloIOEventReader reader, File file) throws IOException, XMLStreamException {
		// Load tree topology:
