...
public class FilterTest {
	...
	@Test
	public void testAbsoluteNumericFilter() throws SQLException {
		...
		try {
			...
			TreeFilter<NumericTreeFilterDefinition.Absolute> filter = TreeFilterFactory.getInstance().createTreeFilter(definition, table);
	...
	@Test
	public void testBooleanFilter() throws SQLException {
		...
		try {
			TreeUserDataTable table = new TreeUserDataTable(userDataConnection, treeOrder, expressions.treeUserValueNames());
			putUserValue(table, id0, 0);
			putUserValue(table, id1, 1);
			putUserValue(table, id2, 0);
			putUserValue(table, id3, 1);
			putUserValue(table, id4, 0);

			TreeFilter<BooleanTreeFilterDefinition> filter = TreeFilterFactory.getInstance().createTreeFilter(definition, table);
